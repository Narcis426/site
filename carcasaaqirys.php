...
<table>
  <tbody>
    <tr>
            ...
            <ul class="orbit-container">
              <li class="is-active orbit-slide">
                <figure class="orbit-figure">
                  <img class="orbit-image" width="300" height="200" src="carcasaaqirys.jpg" alt="Carcasa AQIRYS">
                </figure>
              </li>
              <li class="orbit-slide">
                <figure class="orbit-figure">
                  <img class="orbit-image" width="300" height="200" src="carcasaaqirys2.jpg" alt="Carcasa AQIRYS">
                </figure>
              </li>
              <li class="orbit-slide">
                <figure class="orbit-figure">
                  <img class="orbit-image" width="300" height="200" src="carcasaaqirys3.jpg" alt="Carcasa AQIRYS">
                </figure>
              </li>
              <li class="orbit-slide">
                <figure class="orbit-figure">
                  <img class="orbit-image" width="300" height="200" src="carcasaaqirys4.jpg" alt="Carcasa AQIRYS">
                </figure>
              </li>
            </ul>
          </div>
      ...
      <td><strong>Carcasa AQIRYS Naos Pro, MiddleTower, Tempered glass, Negru</strong></td>
    </tr>
  </tbody>
</table>
<h2>439 Lei</h2>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Panou lateral transparent</td>
      <td>Da, plexiglass</td>
    </tr>
    <tr>
      <td>Permite Asamblare</td>
      <td>Gold</td>
    </tr>
    <tr>
      <td>Permite Wire Management</td>
      <td>Da</td>
    </tr>
  </tbody>
</table>
