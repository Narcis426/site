...
<table>
  <tbody>
    <tr>
            ...
            <ul class="orbit-container">
              <li class="is-active orbit-slide">
                <figure class="orbit-figure">
                  <img class="orbit-image" width="300" height="200" src="ssdsamsung.jpg" alt="Space">
                </figure>
              </li>
              <li class="orbit-slide">
                <figure class="orbit-figure">
                  <img class="orbit-image" width="300" height="200" src="ssdsamsung2.jpg" alt="Space">
                </figure>
              </li>
            </ul>
          </div>
      ...
      <td><strong>SSD Samsung 870 QVO 2TB SATA-III 2.5 inch MZ-77Q2T0BW</strong></td>
    </tr>
  </tbody>
</table>
<h2>729 Lei</h2>
